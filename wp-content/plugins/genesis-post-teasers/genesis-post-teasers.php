...
if ( genesis_get_option('teasers_enable') == 'Blog Template' ) {
	if ( genesis_get_custom_field('gpt_blog_cat_id') )
		$cat_id = genesis_get_custom_field('gpt_blog_cat_id');
	if ( genesis_get_custom_field('gpt_blog_tag') )
		$tag_id = genesis_get_custom_field('gpt_blog_tag');
}
...
global $_genesis_theme_settings_pagehook;
	add_action('genesis_theme_settings_metaboxes', 'gPostTeaz_settings_boxes');
	add_action('genesis_theme_settings_metaboxes', 'gPostTeaz_settings_scripts');
}
