...
add_action( 'widgets_init', 'c7s_ads_220x125_widgets' );

function c7s_ads_220x125_widgets() {
	register_widget( 'c7s_ads_220x125_widget' );
}

class c7s_ads_220x125_widget extends WP_Widget {

/*-----------------------------------------------------------------------------------*/
/*	Setup
/*-----------------------------------------------------------------------------------*/

	function c7s_ads_220x125_widget() {
	
		/* Widget settings */
		$widget_ops = array( 'classname' => 'c7s-ad-widget', 'description' => __( 'Display up to six 220x125 ad blocks.', 'framework' ) );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'c7s_ads_220x125_widget' );

		/* Create the widget */
		$this->WP_Widget( 'c7s_ads_220x125_widget', __( 'Custom Ad(s) 220x125 - Sidebar', 'framework' ), $widget_ops, $control_ops );
	}
...
/*-----------------------------------------------------------------------------------*/
	...
	function widget( $args, $instance ) {
		...
		echo '<div class="ads-220x125 clearfix">';
