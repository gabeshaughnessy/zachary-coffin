...
Description: Configure upto 6 125x125 advertisement areas
Version: 1.1
Author: Luke McDonald
Author URI: http://www.lukemcdonald.com
*/

add_action( 'widgets_init', 'c7s_ads_125x125_widgets' );

function c7s_ads_125x125_widgets() {
	register_widget( 'c7s_ads_125x125_widget' );
}

class c7s_ads_125x125_widget extends WP_Widget {

/*-----------------------------------------------------------------------------------*/
/*	Setup
/*-----------------------------------------------------------------------------------*/

	function c7s_ads_125x125_widget() {
	
		/* Widget settings */
		$widget_ops = array( 'classname' => 'c7s-ad-widget', 'description' => __( 'Display up to six 125x125 ad blocks.', 'framework' ) );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'c7s_ads_125x125_widget' );

		/* Create the widget */
		$this->WP_Widget( 'c7s_ads_125x125_widget', __( 'Custom Ad(s) 125x125 - Footer', 'framework' ), $widget_ops, $control_ops );
	}
...
/*-----------------------------------------------------------------------------------*/
	...
	function widget( $args, $instance ) {
		...
		echo '<div class="ads-125x125 clearfix">';
		echo '<ul class="clearfix">';

		/* Display Ad 1. */
		if ( $link1 )
			$ads[] = '<li><a href="' . esc_url( $link1 ) . '"><img src="' . esc_url( $ad1 ) . '" width="125" height="125" alt="" /></a></li>';
			
		elseif ( $ad1 )
		 	$ads[] = '<li><img src="' . esc_url( $ad1 ) . '" width="125" height="125" alt="" /></li>';
		
		/* Display Ad 2. */
		if ( $link2 )
			$ads[] = '<li><a href="' . esc_url( $link2 ) . '"><img src="' . esc_url( $ad2 ) . '" width="125" height="125" alt="" /></a></li>';
			
		elseif ( $ad2 )
		 	$ads[] = '<li><img src="' . esc_url( $ad2 ) . '" width="125" height="125" alt="" /></li>';
			
		/* Display Ad 3. */
		if ( $link3 )
			$ads[] = '<li><a href="' . esc_url( $link3 ) . '"><img src="' . esc_url( $ad3 ) . '" width="125" height="125" alt="" /></a></li>';
			
		elseif ( $ad3 )
		 	echo '<li><img src="' . esc_url( $ad3 ) . '" width="125" height="125" alt="" /></li>';
			
		/* Display Ad 4. */
		if ( $link4 )
			$ads[] = '<li><a href="' . esc_url( $link4 ) . '"><img src="' . esc_url( $ad4 ) . '" width="125" height="125" alt="" /></a></li>';
			
		elseif ( $ad4 )
		 	$ads[] = '<li><img src="' . esc_url( $ad4 ) . '" width="125" height="125" alt="" /></li>';
			
		/* Display Ad 5. */
		if ( $link5 )
			$ads[] = '<li><a href="' . esc_url( $link5 ) . '"><img src="' . esc_url( $ad5 ) . '" width="125" height="125" alt="" /></a></li>';
			
		elseif ( $ad5 )
		 	$ads[] = '<li><img src="' . esc_url( $ad5 ) . '" width="125" height="125" alt="" /></li>';
			
		/* Display Ad 6. */
		if ( $link6 )
			$ads[] = '<li><a href="' . esc_url( $link6 ) . '"><img src="' . esc_url( $ad6 ) . '" width="125" height="125" alt="" /></a></li>';
			
		elseif ( $ad6 )
		 	$ads[] = '<li><img src="' . esc_url( $ad6 ) . '" width="125" height="125" alt="" /></li>';
...
/*-----------------------------------------------------------------------------------*/
	...
	function form( $instance ) {
		...
		'ad1'    => get_template_directory_uri()."/images/banner-125x125.png",
		'link1'  => 'http://www.lukemcdonald.com',
		'ad2'    => get_template_directory_uri()."/images/banner-125x125.png",
