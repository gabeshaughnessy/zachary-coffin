...
add_action( 'widgets_init', 'c7s_ad_250x125_widgets' );

function c7s_ad_250x125_widgets() {
	register_widget( 'c7s_ad_250x125_widget' );
}

class c7s_ad_250x125_widget extends WP_Widget {

/*-----------------------------------------------------------------------------------*/
/*	Setup
/*-----------------------------------------------------------------------------------*/

	function c7s_ad_250x125_widget() {
	
		/* Widget settings */
		$widget_ops = array( 'classname' => 'c7s-ad-widget', 'description' => __( 'Display a single 250x125 ad block.', 'framework' ) );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'c7s_ad_250x125_widget' );

		/* Create the widget */
		$this->WP_Widget( 'c7s_ad_250x125_widget', __( 'Custom Ad 250x125 - Footer', 'framework' ), $widget_ops, $control_ops );
	}
