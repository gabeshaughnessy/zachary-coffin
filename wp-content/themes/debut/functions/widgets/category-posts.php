...
function CategoryPosts() {
	parent::WP_Widget(false, $name='Custom Category Posts' );
}
...
function widget( $args, $instance) {
	...
	?>
		<li class='cat-post-item'>
			...
			<h4 class='post-title'>
			  <a href='<?php the_permalink(); ?>' rel='bookmark' class='post-title'  title='Permanent Link to <?php the_title_attribute(); ?>'>
...
?>
	...
	<p>
		<label for='<?php echo $this->get_field_id( 'excerpt' ); ?>'>
			...
			<?php _e( 'Show post excerpt', 'framework' ); ?>
		</label>
	</p>
	
	<p>
		<label for='<?php echo $this->get_field_id( 'excerpt_length' ); ?>'>
			<?php _e( 'Excerpt length (in words):', 'framework' ); ?>
		</label>
