<div id="c7s-post-page" class="c7s-metabox">
	
	<div class="section">
	
		<div class="header">
			<p><?php echo __( 'Choose to show this page\'s title and/or content.', 'framework' ); ?></p>
		</div>
		<!-- .header -->
		...
		<div class="content">
			<div class="col w50">
			  <p>
			    <label class="txtnormal">
			      ...
			      <?php echo __( 'Show Title', 'framework' ); ?>
			    </label>
			  </p>
			  <p>
			    <label class="txtnormal">
			      ...
			      <input type="checkbox" name="<?php $mb->the_name(); ?>" value="1"<?php if ( $mb->get_the_value() ) echo ' checked="checked"'; ?>/> 
			      <?php echo __( 'Show Content', 'framework' ); ?>
			    </label>
			  </p>
			</div>
			<!-- .column -->
			<div class="col w50">
			  <p>
			    <label><?php echo __( 'Number of Posts:' , 'framework' ); ?></label>
	...
	<div class="section">
		...
		<div class="header">
			<p><?php echo __( 'All categories are shown by default.', 'framework' ); ?></p>
		</div>
		<!-- .header -->
		
		<div id="c7s-post-page-terms" class="content">
			<p>
...
/* Tab Styles */
#c7s-post-page #c7s-post-page-terms {
	overflow: auto;
	max-height: 100px;
}
</style>
