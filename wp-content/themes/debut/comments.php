...
<?php if ( have_comments() ) : ?>
			...
			printf( _n( 'One Response to %2$s', '%1$s Responses to %2$s', get_comments_number(), 'c7s' ),
...
<?php endif; // check for comment navigation ?>
			...
			<ol class="commentlist">
				<?php
					 ...
					 * to use c7s_comment() to format the comments.
					 * If you want to overload this in a child theme then you can
					 * define c7s_comment() and that will be used instead.
					 * See c7s_comment() in functions.php for more.
					 */
					//wp_list_comments( array( 'callback' => 'c7s_comment' ) );
					wp_list_comments( array( 'avatar_size' => 40, 'type' => 'comment' ) );
				?>
			</ol>
