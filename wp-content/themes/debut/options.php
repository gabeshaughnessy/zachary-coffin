<?php
/**
 * The main options file that gets and sets the available options for this theme and version
 *
 * @package WordPress
 * @subpackage Debut
 * @since Debut 2.0
...
function optionscheck_change_santiziation() {
	...
	add_filter( 'of_sanitize_info', 'c7s_of_sanitize_allowedtags' );
}

function c7s_of_sanitize_allowedtags( $input ) {
	global $allowedtags;
...
/**
 * Add custom CSS Styles to OF Plugin to help with display of theme options and sections.
 *
 * @since Debut 2.6
 *
 */
 
add_action( "admin_print_styles-$of_page", 'c7s_optionsframework_styles' );

function c7s_optionsframework_styles() { ?>
...
/**
 * Add custom scripts to OF Plugin.
 *
 * @since Debut 2.6
 *
 */
...
if ( ! function_exists( 'optionsframework_options' ) ) {
	...
	function optionsframework_options() { 
		...
		$admin_imagepath = get_template_directory_uri() . '/functions/images/';
		
		// Pull all the categories into an array
		$options_categories = array();  
		$options_categories_obj = get_categories();
		$options_categories[''] = __( 'Select a category:', 'framework' );
		...
		$options_pages[''] = __( 'Select a page:', 'framework' );
		...
		include( 'options/options-plugins.php' );
		include( 'options/options-help.php' );
